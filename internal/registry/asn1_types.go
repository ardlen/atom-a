...
type SignedData struct {
	...
	Certificates     asn1.RawValue `asn1:"optional,explicit,tag:0"` // SET OF Certificate (OCTET STRING)
...
type SignerInfo struct {
	...
	DigestAlgorithm           AlgorithmIdentifier
	AuthenticatedAttributes   asn1.RawValue `asn1:"optional,explicit,tag:0"` // SET OF Attribute (ATOM и стандартные)
	DigestEncryptionAlgorithm AlgorithmIdentifier
	EncryptedDigest           []byte
	UnauthenticatedAttributes asn1.RawValue `asn1:"optional,explicit,tag:1"`
}
